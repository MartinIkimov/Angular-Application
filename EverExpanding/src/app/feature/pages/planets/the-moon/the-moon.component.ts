...
@Component({
  selector: 'app-the-moon',
  templateUrl: './the-moon.component.html',
  styleUrls: ['./the-moon.component.css']
})
export class TheMoonComponent implements AfterViewInit {
  ...
  private renderPlanet() {
    ...
    const sphere = new THREE.Mesh(new THREE.SphereGeometry(5, 50, 50),
      new THREE.MeshBasicMaterial({
        ...
        map: new THREE.TextureLoader().load('/assets/planets/the-moon/8k_the_moon.jpg')
      }));
